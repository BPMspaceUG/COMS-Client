...
if (isset($_POST['data'])) {
    ...
    if ($_POST['data'] == 'edit-exam-event') {
        ...
        if ($exam_event_data) {
            ...
            require_once($_SERVER['DOCUMENT_ROOT'] . '/inc/templates/edit_exam_event.inc.php');
        }
    }
    if ($_POST['data'] == 'show-participation-list') {
        ...
        require_once($_SERVER['DOCUMENT_ROOT'] . '/inc/templates/participation.inc.php');
    ...
    if ($_POST['data'] == 'edit-participant') {
        ...
        require_once($_SERVER['DOCUMENT_ROOT'] . '/inc/templates/edit_participant.inc.php');
    }
    if ($_POST['data'] == 'search-participant') {
        ...
        //require_once($_SERVER['DOCUMENT_ROOT'] . '/inc/templates/search_participant.inc.php');
    ...
    if (!$error_records && !$book_records && !$create_records) {
        ...
        require_once($_SERVER['DOCUMENT_ROOT'] . '/inc/templates/import_participants.inc.php');
    }
}